...
public class Bebidas extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String[] itens = getResources().getStringArray(R.array.array_bebidas);
        // criar obj de alimentos
        final ArrayList<Alimento> lista = FuncoesGlobais.criarAlimento(itens, FuncoesGlobais.bebidas_valores);
        ...
        proximo.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                FuncoesGlobais.totalBebidas = FuncoesGlobais.calcularTotal(valorSelecionados);

                // salvando escolhas
                FuncoesGlobais.salvarEscolhas(
                        getContext(),
                        FuncoesGlobais.arqBebidas,
                        selecionados,
