...
public class ZeroAcucar extends Fragment {
    View myView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Zero Açucar");
        ...
        String[] itens = getResources().getStringArray(R.array.array_zeroacucar);
        // criar obj de alimentos
        final ArrayList<Alimento> lista = FuncoesGlobais.criarAlimento(itens, FuncoesGlobais.zeroAcucar_valores);
        ...
        proximo.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                FuncoesGlobais.totalZeroAcucar = FuncoesGlobais.calcularTotal(valorSelecionados);

                // salvando escolhas
                FuncoesGlobais.salvarEscolhas(
                        getContext(),
                        FuncoesGlobais.arqZeroAcucar,
                        selecionados,
