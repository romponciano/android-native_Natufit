...
public class Oleaginosas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Opções de Oleaginosas");
        ...
        String[] itens = getResources().getStringArray(R.array.array_oleaginosas);
