...
public class LowCarb extends Fragment {
    View myView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String[] itens = getResources().getStringArray(R.array.array_low_carb);
        // criar obj de alimentos
        final ArrayList<Alimento> lista = FuncoesGlobais.criarAlimento(itens, FuncoesGlobais.lowcarbs_valores);
        ...
        proximo.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                FuncoesGlobais.totalLowCarbs = FuncoesGlobais.calcularTotal(valorSelecionados);

                // salvando escolhas
                FuncoesGlobais.salvarEscolhas(
                        getContext(),
                        FuncoesGlobais.arqLowCarb,
                        selecionados,
